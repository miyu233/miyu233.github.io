		...
		*/
		...
		r.prototype.init = function (e) {
			...
			try {
				...
				n && r && e.installLocale(n, r), e.locale = e.locale || g[n || "zh-cn"], e.notify = c || !1, e.verify = d || !1, m.params = "?d=" + (O.indexOf(i) > -1 ? i : "mp"), m.hide = "hide" === i, m.cdn = h.test(l) ? l : m.cdn, y = e.config.path || y;
				var $ = Number(x || 10);
